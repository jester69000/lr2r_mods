screen person_info_detailed(person):
    ...
    ### Add retighting serum and gym classes


    
    ### Make informations only visible with nanobots?


    ### Move advancing reserch to RnD menu
    ### Move personal serums to Production menu
    ### Move company photo shoot to marketing menu

    ### Make initlisation UI with cahracter customization
    ### Toggable serums
    ### selectable goals block Goals adjustment (new Goal: Bujjaje?)
    ...
    default fertility_at_peak = f"{0.3*person.fertility_percent:.1f}%" ###jes: Added at peak calculation
                        ...
                        if person.knows_pregnant:
                            ...
                            if persistent.pregnancy_pref > 0:
                                if person.has_event_day("last_birth") and person.days_since_event("last_birth") < 21:
                                    ...
                                    hbox: ### jes: Added at peak info
                                        text "Fertility: [fertility_info] (At peak: [fertility_at_peak])" style "menu_text_style"
        ...
        hbox:
            ...
            frame:
                ...
                vbox xfill True:
                    ...
                    ###jes: Added vagina_thightness
                    if person.vagina_tightness == 0:
                        text "Thightness: Virgin" style "menu_text_style"
                    elif person.vagina_tightness == 1:
                        text "Thightness: Very Tight" style "menu_text_style"
                    elif person.vagina_tightness == 2:
                        text "Thightness: Tight" style "menu_text_style"
                    elif person.vagina_tightness == 3:
                        text "Thightness: Snug" style "menu_text_style"
                    elif person.vagina_tightness == 4:
                        text "Thightness: Slightly Stretched Out" style "menu_text_style"
                    elif person.vagina_tightness == 5:
                        text "Thightness: Stretched Out" style "menu_text_style"
                    elif person.vagina_tightness == 6:
                        text "Thightness: Very Stretched Out" style "menu_text_style"
                    elif person.vagina_tightness == 7:
                        text "Thightness: Loose" style "menu_text_style"
                    elif person.vagina_tightness == 8:
                        text "Thightness: Very Loose" style "menu_text_style"
                    else:
                        text "Thightness: Gaping" style "menu_text_style"
