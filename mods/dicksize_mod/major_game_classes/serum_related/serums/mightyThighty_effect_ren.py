...
serum = SerumTraitMod(name = "Migthy Tighty Effect",
    desc = "Restores vagina tightness",
    positive_slug = "Increases vagina tightness",
    negative_slug = "Reduces energy",
    research_added = 500,
    production_added = 25,
    ...
    clarity_cost = 1000,
    hidden_tag = "Physical",
    mental_aspect = 0, physical_aspect = 2, sexual_aspect = 3, medical_aspect = 1, flaws_aspect = 0, attention = 3)
